            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                    ...
                    <td class="px-6 py-4 flex gap-2">
                            <form action="/dashboard/category/{{ $author->slug }}" method="POST" class="text-red-500 hover:text-red-700">
                                @csrf
                                @method('DELETE')
                            ...
                            <div class="text-yellow-500 hover:text-yellow-700">
                              <a href="/dashboard/category/{{ $author->slug }}/edit"><i class="fa-utility fa-semibold fa-pen-to-square"></i> Edit</a>
                            </div>
                    </td>
                </tr>  
                @endforeach
