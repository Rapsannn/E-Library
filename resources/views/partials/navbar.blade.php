                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/borrows/{{ auth()->user()->slug }}"
                                class="rounded-md px-3 py-2 text-sm font-medium {{ request()->is('/borrows*') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}"
                                aria-current="page">Borrows</a>
                        @endauth
                        <a href="/about"
                    ...
                    <div class="ml-4 flex items-center md:ml-6">
                        ...
                        <div class="relative ml-3">
                            ...
                            <div x-show="isOpen" x-transition:enter="transition ease-out duration-100 transform"
                                ...
                                <a href="/dashboard" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-300 transition" role="menuitem"
                                    tabindex="-1" id="user-menu-item-0">Dashboard</a>
                                    @endif
                                <form action="/logout" method="POST">
                                    @csrf
                                    <button type="submit" class="block px-4 py-2 text-sm text-gray-700 cursor-pointer hover:bg-gray-300 transition w-full text-left" onclick="return confirm('Are you sure you want to logout?')" role="menuitem"
    ...
    @auth
        ...
        <div x-show="isOpen" class="md:hidden" id="mobile-menu">
            <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
                ...
                @auth
                    <a href="/borrows/{{ auth()->user()->slug }}"
                    class="block rounded-md px-3 py-2 text-base font-medium {{ request()->is('/borrows*') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">Borrows</a>
                @endauth
                <a href="/about"
